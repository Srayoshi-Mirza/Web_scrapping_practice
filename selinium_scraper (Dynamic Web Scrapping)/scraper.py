...
##DBLP=Number of publication
#D-index (Discipline H-index)
...
def main():
    ...
    df.to_csv("best_scientist_details.csv", index = False) #file that going to get data


    return

if __name__=="__main__": #This format is good practice
    main()